...
MODELPATH="/home/chenda/ckpt/internvl-8B_drive_trainval_merge/"   #Where the ckpt is stored
RECORDPATH="/home/weizhen/hope/8b_proper"
PROMPTSCHEMA="direct"
RESULTPATH="/home/weizhen/hope/8b_proper/result.json"
