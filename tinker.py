...
if __name__ == "__main__":
    ...
    # with open("C:\\research\\dataset\\.objaverse\\hf-objaverse-v1\\{}".format(path), "w+") as f:
    #     for uid, path in objects.items():
    #         f.write("{}:{}\n".format(uid,path))
    tag = "stop"
    taglist = ["truckstop","stop-sign-board","stoplight","bus-stop","stopsign","stop","busstop", "roadstop",
               "stop-sign-ts", "stop-light", "truck-stop", "gasstop", "stop-sign", "bus-stop-sign"]
