...
class TestAssetMetaDriveEnv(BaseEnv):
    @classmethod
    def default_config(cls) -> Config:
        config = super(TestAssetMetaDriveEnv, cls).default_config()
    ...
    def __init__(self, config: Union[dict, None] = None):
        ...
        super(TestAssetMetaDriveEnv, self).__init__(config)
