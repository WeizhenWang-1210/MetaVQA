...
from metadrive.manager.test_asset_agent_manager import TestAssetAgentManager
...
class ShowAssetMetaDriveEnv(BaseEnv):
    @classmethod
    def default_config(cls) -> Config:
        config = super(ShowAssetMetaDriveEnv, cls).default_config()
    ...
    def __init__(self, config: Union[dict, None] = None):
        ...
        super(ShowAssetMetaDriveEnv, self).__init__(config)
    ...
    def _post_process_config(self, config):
        config = super(ShowAssetMetaDriveEnv, self)._post_process_config(config)
    ...
    def step(self, test_asset_config_dict = None, actions = None):
        ...
        ret = super(ShowAssetMetaDriveEnv, self).step(actions)
        while self.in_stop:
    ...
    def setup_engine(self):
        super(ShowAssetMetaDriveEnv, self).setup_engine()
