...
class TestPedeMetaDriveEnv(BaseEnv):
    @classmethod
    def default_config(cls) -> Config:
        config = super(TestPedeMetaDriveEnv, cls).default_config()
    ...
    def __init__(self, config: Union[dict, None] = None):
        ...
        super(TestPedeMetaDriveEnv, self).__init__(config)
    ...
    def _get_observations(self):
        print(self.config["vehicle_config"])
    ...
    def step(self, *args, **kwargs):
        ret = super(TestPedeMetaDriveEnv, self).step(*args, **kwargs)
        while self.in_stop:
    ...
    def setup_engine(self):
        super(TestPedeMetaDriveEnv, self).setup_engine()
        ...
        from metadrive.manager.test_asset_traffic_manager import NewAssetPGTrafficManager
