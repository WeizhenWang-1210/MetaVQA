...
from vqa.vqagen.utils.qa_utils import create_options, create_multiple_choice, enumerate_frame_labels
...
SETTINGS = [
    dict(font_scale=textscale, form=form, background_color=background) for (textscale, form, background) in
    itertools.product(TEXTSCALES, FORMS, BACKGROUND)
]
